...
export const refreshTasksTool: Tool = {
  name: 'refresh-tasks',
  description: i18n.t('tools.refreshTasks.description'),
  inputSchema: {
    type: 'object',
    properties: {
      projectPath: { 
        type: 'string',
        description: i18n.t('tools.refreshTasks.projectPathDescription')
      },
      specName: { 
        type: 'string',
        description: i18n.t('tools.refreshTasks.specNameDescription')
      }
    },
...
export async function refreshTasksHandler(args: any, context: ToolContext): Promise<ToolResponse> {
  ...
  try {
    ...
    if (!hasRequirements && !hasDesign) {
      return {
        success: false,
        message: i18n.t('tools.refreshTasks.noSpecDocuments'),
        nextSteps: [
          i18n.t('tools.refreshTasks.createRequirementsFirst'),
          i18n.t('tools.refreshTasks.createDesignNext'),
          i18n.t('tools.refreshTasks.thenRefresh')
        ]
      };
    }
...
**REMEMBER**: If a feature exists in tasks but NOT in requirements.md/design.md, it has been CUT from the spec and pending tasks should be REMOVED.`;
    ...
    return {
      success: true,
      message: i18n.t('tools.refreshTasks.successMessage', { specName }),
      data: {
        context: fullContext,
        specName,
        hasRequirements,
      ...
      nextSteps: [
        i18n.t('tools.refreshTasks.pass1'),
        i18n.t('tools.refreshTasks.pass2'),
        i18n.t('tools.refreshTasks.decision'),
        i18n.t('tools.refreshTasks.pass3')
      ],
      projectContext: {
        projectPath,
    ...
    return {
      success: false,
      message: i18n.t('tools.refreshTasks.failureMessage', { errorMessage: error.message }),
      nextSteps: [
        i18n.t('tools.refreshTasks.checkSpecDir'),
        i18n.t('tools.refreshTasks.checkPermissions'),
        i18n.t('tools.refreshTasks.checkSpecName')
      ]
    };
  }
}
